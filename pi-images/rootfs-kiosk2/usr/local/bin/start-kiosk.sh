...
chromium-browser --kiosk --no-first-run --incognito --disable --disable-translate --disable-infobars --disable-suggestions-service --disable-save-password-bubble --disk-cache-dir=/run/user/1000/browsercache --user-data-dir=/run/user/1000/browser --start-maximized    "$KIOSKURI"
exit 0
